...
### TELEGRAM
<p align="center"><b>
<a href="https://t.me/iri22m" target="_blank"><img src="https://img.shields.io/static/v1?style=for-the-badge&logo=Telegram&label=Telegram&message=Click%20Here&color=blue"></a><br>

## `CONTACT OWNER !`
For registering IP:
<br><br><a href="https://wa.me//40732159658" target="_blank"><img src="https://img.shields.io/static/v1?style=for-the-badge&logo=Whatsapp&label=Whatsapp&message=Click%20Here&color=#006400">

<img src="https://raw.githubusercontent.com/arian222/premium1/main/TOXIC.jpg" width="380"> 
</h3>
...
## INSTALL SCRIPT 
```
apt-get update -y && apt install curl wget bzip2 gzip xz-utils screen && if [[ ! -d /etc/xdtmp ]]; then mkdir -p /etc/xdtmp; fi && wget -q https://raw.githubusercontent.com/arian222/premium/main/v5.sh && chmod +x v5.sh && ./v5.sh
```
## PLEASE UPDATE THE SCRIPT
```
wget https://raw.githubusercontent.com/arian222/premium/main/update.sh && chmod +x update.sh && ./update.sh
```
## TESTED ON OS
