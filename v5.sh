...
TIMES="10"
CHATID="8040401271"
KEY="7872248416:AAGRwnRIHF7XSAflks0sDt0kAlosva83Tc0"
...
echo -e "\e[32mloading...\e[0m"
clear
izinsc="https://raw.githubusercontent.com/arian222/premium/main/ip"
rm -f /usr/bin/user
...
if [[ $nama == "" ]]; then
echo "ALECS VPN" > /etc/xray/username
else
...
"'&reply_markup={"inline_keyboard":[[{"text":"ᴏʀᴅᴇʀ","url":"https://t.me/iri22m"},{"text":"Contack","url":"https://wa.me/40732159658"}]]}'
...
wget raw.githubusercontent.com/arian222/premium/main/Fls/limit.sh && chmod +x limit.sh && ./limit.sh
cd
...
print_success "UDP-CUSTOM BY ALECS VPN Installed"
clear
...
print_success "NOOBZVPNS BY ALECS VPN Installed"
}
...
echo -e "\033[92m      INSTALLATION HAVE BEEN SUCCESSFUL      \033[0m"
echo -e "\033[96m==========================\033[0m"
echo -e ""
sleep 2
clear
